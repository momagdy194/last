    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h3>Products</h3>
                <div class="card">
                    <div class="card-header">Products <a href="{{route('new-product')}}" class="btn btn-primary"><i
                            ...
                            @foreach ($products as $product)
                                <div class="col-md-4">
                                    <div class="alert alert-primary">
                                        ...
                                        <p>
                                            Category: {{ is_object($product->category) ? $product->category->name : ''}}</p>
                                        <p>Product price: {{ $currency_code }}{{$product->price}}</p>

                                        {{--                                        @php--}}
                                        {{--                                            $imageUrl='';--}}
                                        {{--if(count($product->images)>0){--}}
                                        {{--    if(Strops($product->images[0]->url,'https')!==false||Strops($product->images[0]->url,'http')!==false){--}}
                                        ...
                                        <a class="btn btn-success mt-2"
                                           href="{{route('update-new-product' , ['id' => $product->id])}}">Update
                                            Product</a>
